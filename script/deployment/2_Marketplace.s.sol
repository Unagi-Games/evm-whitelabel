...
contract DeployMarketplace is Script {
    function getDeployedNFTAddress() internal view returns (address) {
    ...
    function run() external {
        ...
        address nftAddress = getDeployedNFTAddress();
        ...
        marketplace.grantRole(marketplace.DEFAULT_ADMIN_ROLE(), msg.sender);
